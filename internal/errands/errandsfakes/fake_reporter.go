...
type FakeReporter struct {
	PrintReportStub        func(report string, err error)
...
func (fake *FakeReporter) PrintReportArgsForCall(i int) (string, error) {
	fake.printReportMutex.RLock()
	defer fake.printReportMutex.RUnlock()
	return fake.printReportArgsForCall[i].report, fake.printReportArgsForCall[i].err
}
